    ...
    app.LoadService = (function() {
        ...
        LoadService.prototype.tHr = function(tHt, t, tRqCt, tRqCn, tRqDu, tRqIn, rq) {
            var cRS = function() {
                ...
                oRR = function(t, re, rs, rq, cc, pix) {
                    var res = re,
                        req = res.Q,
                        hst = res.json.h,
                        ndx = pix[hst][0],
                ...
                oRD = function(t, re, rs, rq, cc, pix) {
                    for (var k = 0; k < re.length; k++) {
                        rq[3][re[k].Q] = k;
                        oRR(t, re[k], rs, rq, cc, pix);
                    }
                },
                cnRq = 0,
                cnRe = 0,
        ...
        LoadService.prototype.pRS = function(rqCt) {
            ...
            for (var q = 0; q < rqCt; q++) {
                var o = this._a_OPE[mR(10)];
                oT[o]++;
                rq[0].push(this._j_ERE);
                rq[1].push(this.hS.get(q, this._s_AURL, o, mR(16384)));
                rq[2].push(o);
                rq[3].push(0);
            }
            return [rq,
