...
gzip -k9flv ./favicon.png
gzip -k9flv ./node_modules/bootstrap/dist/css/bootstrap.min.css
gzip -k9flv ./node_modules/nvd3/build/nv.d3.min.css
gzip -k9flv ./font-awesome-4.6.3/css/font-awesome.min.css
gzip -k9flv ./node_modules/jquery/dist/jquery.min.js
gzip -k9flv ./node_modules/bootstrap/dist/js/bootstrap.min.js
gzip -k9flv ./node_modules/d3/d3.min.js
gzip -k9flv ./node_modules/nvd3/build/nv.d3.min.js
gzip -k9flv ./node_modules/socket.io-client/socket.io.js
gzip -k9flv ./node_modules/intl/dist/Intl.min.js
gzip -k9flv ./node_modules/intl/locale-data/jsonp/en.js
gzip -k9flv ./node_modules/es6-shim/es6-shim.min.js
gzip -k9flv ./node_modules/zone.js/dist/zone.min.js
gzip -k9flv ./node_modules/reflect-metadata/Reflect.js
gzip -k9flv ./node_modules/rxjs/bundles/Rx.umd.min.js
gzip -k9flv ./node_modules/@angular/core/bundles/core.umd.min.js
gzip -k9flv ./node_modules/@angular/common/bundles/common.umd.min.js
gzip -k9flv ./node_modules/@angular/compiler/bundles/compiler.umd.min.js
gzip -k9flv ./node_modules/@angular/platform-browser/bundles/platform-browser.umd.min.js
gzip -k9flv ./node_modules/@angular/platform-browser-dynamic/bundles/platform-browser-dynamic.umd.min.js
gzip -k9flv ./http_profile.umd.js
gzip -k9flv ./ng2-nvd3.js
gzip -k9flv ./app.reference.js
gzip -k9flv ./app.httpservice.js
gzip -k9flv ./app.simulator.js
gzip -k9flv ./main.js
gzip -k9flv ./execution-arch.png
gzip -k9flv ./sequence-diagram.png
gzip -k9flv ./simulator.html
gzip -k9flv ./index.html
