            ...
            var intervalFunction = function() {
                if (self.timerRunning && self.countRequests < self.reqCount) {
                    ...
                    for (var j = 0; j < self.reqConn; j++) {
                        ...
                        self.requests[1].push(self.httpService.get(reqId, self.selectedUrl, self.operationProb[(Math.random() * 4) | 0], (Math.random() * 16384) | 0));
		...
		AppSimulator.prototype.initSimulator = function() {
            ...
            if (this.isDuration) {
                ...
                for (var reqId = 0; reqId < this.reqCount; reqId++) {
                    ...
                    this.requests[1].push(this.httpService.get(reqId, this.selectedUrl, this.operationProb[(Math.random() * 4) | 0], (Math.random() * 16384) | 0));
                }
