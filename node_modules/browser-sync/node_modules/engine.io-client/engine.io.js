    ...
    return (function e (t, n, r) {
        ...
        return s
           ...
           3: [function(_dereq_, module, exports) {
               (function(global) {
                   ...
                   function Socket (uri, opts) {
                       ...
                       this.transports = opts.transports || ['polling',
                                                             'websocket'];
                       this.readyState = '';
                       this.writeBuffer = [];
           ...
           4: [function(_dereq_, module, exports) {
               ...
               {"component-emitter": 16, "engine.io-parser": 20}],
           ...
           6: [function(_dereq_, module, exports) {
               ...
               {"./polling": 8, "component-inherit": 17}],
           ...
           14: [function(_dereq_, module, exports) {
               (function(global) {
                   ...
                   var blobSupportsArrayBufferView = blobSupported && (function() {
                           try {
                               var b = new Blob([new Uint8Array([1,
                                                                 2])]);
                               return b.size === 2;
                           }
                           catch (e) {
           ...
           18: [function(_dereq_, module, exports) {
               ...
               function formatArgs () {
                   ...
                   args = [args[0],
                           c,
                           'color: inherit'].concat(Array.prototype.slice.call(args, 1));
                   ...
                   exports.encodePayloadAsBlob = function(packets, callback) {
                       function encodeOne (packet, doneCallback) {
                           exports.encodePacket(packet, true, true, function(encoded) {
                               ...
                               if (Blob) {
                                   var blob = new Blob([binaryIdentifier.buffer,
                                                        lengthAry.buffer,
                                                        encoded]);
