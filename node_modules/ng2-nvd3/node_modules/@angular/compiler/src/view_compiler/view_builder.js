...
var ViewBuilderVisitor = (function() {
    ...
    ViewBuilderVisitor.prototype.visitElement = function(ast, parent) {
        ...
        if (nodeIndex === 0 && this.view.viewType === core_private_1.ViewType.HOST) {
            ...
            createRenderNodeExpr = constants_1.ViewProperties.renderer.callMethod('createElement', [this._getParentRenderNode(parent),
                                                                                                    o.literal(ast.name),
                                                                                                    debugContextExpr]);
        }
        ...
        for (var i = 0; i < attrNameAndValues.length; i++) {
            ...
            this.view.createMethod.addStmt(constants_1.ViewProperties.renderer.callMethod('setElementAttribute', [renderNode,
                                                                                                                  o.literal(attrName),
                                                                                                                  o.literal(attrValue)])
                                               .toStmt());
        }
    ...
    if (lang_1.isPresent(compileElement)) {
        ...
        collection_1.StringMapWrapper.forEach(compileElement.referenceTokens, function(token, varName) {
            varTokenEntries.push([varName,
                                  lang_1.isPresent(token) ? util_1.createDiTokenExpression(token) : o.NULL_EXPR]);
        });
    }
