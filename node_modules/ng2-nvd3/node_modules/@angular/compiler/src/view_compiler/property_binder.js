...
function bind (view, currValExpr, fieldExpr, parsedExpression, context, actions, method) {
    ...
    var condition = o.importExpr(identifiers_1.Identifiers.checkBinding)
        .callFn([constants_1.DetectChangesVars.throwOnChange,
                 fieldExpr,
                 currValExpr]);
    if (checkExpression.needsValueUnwrapper) {
...
function sanitizedValue (boundProp, renderValue) {
    ...
    var args = [o.importExpr(identifiers_1.Identifiers.SecurityContext).prop(enumValue),
                renderValue];
    ...
    directiveAst.inputs.forEach(function(input) {
        ...
        if (calcChangesMap) {
            ...
            statements.push(constants_1.DetectChangesVars.changes.key(o.literal(input.directiveName))
                                .set(o.importExpr(identifiers_1.Identifiers.SimpleChange).instantiate([fieldExpr,
                                                                                                       currValExpr]))
                                .toStmt());
        }
        if (isOnPushComp) {
