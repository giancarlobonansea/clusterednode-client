...
(function(global, factory) {
    ...
    var CompileElement = (function(_super) {
        ...
        CompileElement.prototype.beforeChildren = function() {
            ...
            if (isPresent(this.component)) {
                ...
                this.view.createMethod.addStmt(this.appElement.callMethod('initComponent', [compExpr,
    ...
    var ViewBuilderVisitor = (function() {
        ...
        ViewBuilderVisitor.prototype.visitElement = function(ast, parent) {
            ...
            for (var i = 0; i < attrNameAndValues.length; i++) {
                ...
                this.view.createMethod.addStmt(ViewProperties.renderer.callMethod('setElementAttribute', [renderNode,
                                                                                                          literal(attrName),
                                                                                                          literal(attrValue)])
                                                   .toStmt());
            }
            ...
            if (isPresent(compViewExpr)) {
                ...
                this.view.createMethod.addStmt(compViewExpr.callMethod('create', [compileElement.getComponent(),
                                                                                  codeGenContentNodes,
                                                                                  NULL_EXPR])
                                                   .toStmt());
            }
    ...
    function bind (view, currValExpr, fieldExpr, parsedExpression, context, actions, method) {
        ...
        var condition = importExpr(Identifiers.checkBinding)
            .callFn([DetectChangesVars.throwOnChange,
                     fieldExpr,
                     currValExpr]);
        if (checkExpression.needsValueUnwrapper) {
    ...
    function bindAndWriteToRenderer (boundProps, context, compileElement) {
        ...
        boundProps.forEach(function(boundProp) {
            ...
            updateStmts.push(THIS_EXPR.prop('renderer')
                                 .callMethod(renderMethod, [renderNode,
    ...
    var CompileEventListener = (function() {
        ...
        CompileEventListener.getOrCreate = function(compileElement, eventTarget, eventName, targetEventListeners) {
            var listener = targetEventListeners.find(function(listener) {
                return listener.eventTarget == eventTarget &&
    ...
    CompileMetadataResolver.ctorParameters = [
        ...
        {type: ViewResolver,},
        {
            type:       undefined,
            decorators: [{type: _angular_core.Optional},
                         {type: _angular_core.Inject, args: [_angular_core.PLATFORM_DIRECTIVES,]},]
        },
        {
            type:       undefined,
            decorators: [{type: _angular_core.Optional},
                         {type: _angular_core.Inject, args: [_angular_core.PLATFORM_PIPES,]},]
        },
        {type: ReflectorReader,},
    ];
