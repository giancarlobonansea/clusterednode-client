...
TemplateParser.ctorParameters = [
    ...
    {type: Console,},
    {
        ...
        decorators: [{type: Optional},
                     {type: Inject, args: [TEMPLATE_TRANSFORMS,]},]
    },
];
class TemplateParseVisitor {
    ...
    _createElementPropertyAsts (elementName, props, directives) {
        ...
        props.forEach((prop) = > {
            if (
        !prop.isLiteral && isBlank(boundDirectivePropsIndex.get(prop.name))
    )
        {
...
class NonBindableVisitor {
    visitElement (ast, parent) {
        ...
        var attrNameAndValues = ast.attrs.map(attrAst = > [attrAst.name,
                                                           attrAst.value]
    )
        ;
