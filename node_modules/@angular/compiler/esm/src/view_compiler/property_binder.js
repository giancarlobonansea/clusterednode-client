import {
    EMPTY_STATE as EMPTY_ANIMATION_STATE,
    LifecycleHooks,
    SecurityContext,
...
function bind(view, currValExpr, fieldExpr, parsedExpression, context, actions, method) {
    ...
    var condition = o.importExpr(Identifiers.checkBinding).callFn([
    ...
    var oldRenderValue = sanitizedValue(boundProp, fieldExpr);
        ...
        switch (boundProp.type) {
            ...
            case PropertyBindingType.Animation:
                ...
                updateStmts.push(animation.fnVariable.callFn([o.THIS_EXPR,
                                                              renderNode,
                                                              oldRenderVar,
                                                              newRenderVar])
                                     .toStmt());
                view.detachMethod.addStmt(animation.fnVariable.callFn([o.THIS_EXPR,
                                                                       renderNode,
                                                                       oldRenderValue,
                                                                       emptyStateValue])
                                              .toStmt());
