...
(function(global, factory) {
    ...
    var KEYWORDS = SetWrapper.createFromList(['var',
                                              'let',
                                              'null',
                                              'undefined',
                                              'true',
    ...
    var TAG_DEFINITIONS = {
        ...
        'tbody':    new HtmlTagDefinition({
            closedByChildren: ['tbody',
                               'tfoot'], closedByParent: true
        }),
        'tfoot':    new HtmlTagDefinition({closedByChildren: ['tbody'], closedByParent: true}),
        'tr':       new HtmlTagDefinition({
            closedByChildren: ['tr'],
            requiredParents:  ['tbody',
                               'tfoot',
                               'thead'],
            closedByParent:   true
        }),
        ...
        'dd':       new HtmlTagDefinition({
            closedByChildren: ['dt',
                               'dd'], closedByParent: true
        }),
        'rb':       new HtmlTagDefinition({
            closedByChildren: ['rb',
                               'rt',
                               'rtc',
                               'rp'], closedByParent: true
        }),
        ...
        'option':   new HtmlTagDefinition({
            closedByChildren: ['option',
                               'optgroup'], closedByParent: true
        }),
    ...
    function isExpansionFormStart (input, offset, interpolationStart) {
        ...
        return StringWrapper.charCodeAt(substr, 0) === $LBRACE$1 &&
            StringWrapper.charCodeAt(substr, 1) !== $LBRACE$1 && !substr.startsWith(interpolationStart);
    }
        ...
        CompileDirectiveMetadata.create = function(_a) {
            ...
            if (isPresent(inputs)) {
                inputs.forEach(function(bindConfig) {
                    ...
                    var parts = splitAtColon(bindConfig, [bindConfig,
                                                          bindConfig]);
    ...
    TemplateParser.ctorParameters = [
        ...
        {type: Console,},
        {
            ...
            decorators: [{type: _angular_core.Optional},
                         {type: _angular_core.Inject, args: [TEMPLATE_TRANSFORMS,]},]
        },
    ];
    var TemplateParseVisitor = (function() {
        ...
        TemplateParseVisitor.prototype._parseEvent = function(name, expression, sourceSpan, targetMatchableAttrs, targetEvents) {
            ...
            var parts = splitAtColon(name, [null,
                                            name]);
            var target = parts[0];
    ...
    function removeDuplicates (items) {
        ...
        items.forEach(function(item) {
            var hasMatch = res.filter(function(r) {
                    return r.type.name == item.type.name && r.type.moduleUrl == item.type.moduleUrl &&
    ...
    var ExpressionTransformer = (function() {
        ...
        ExpressionTransformer.prototype.visitLiteralMapExpr = function(ast, context) {
            ...
            return new LiteralMapExpr(ast.entries.map(function(entry) {
                return [entry[0],
                        entry[1].visitExpression(_this, context)];
            }));
        };
        ...
        CompileElement.prototype.beforeChildren = function() {
            ...
            if (isPresent(this.component)) {
                ...
                this.view.createMethod.addStmt(this.appElement
                                                   .callMethod('initComponent', [compExpr,
    ...
    var _ValueOutputAstTransformer = (function(_super) {
        ...
        _ValueOutputAstTransformer.prototype.visitStringMap = function(map, context) {
            ...
            StringMapWrapper.forEach(map, function(value /** TODO #9100 */, key /** TODO #9100 */) {
                entries.push([key,
                              visitValue(value, _this, context)]);
            });
    ...
    var CompileView = (function() {
        ...
        CompileView.prototype.createLiteralMap = function(entries) {
            ...
            for (var i = 0; i < entries.length; i++) {
                var paramName = "p" + i;
                proxyParams.push(new FnParam(paramName));
                proxyReturnEntries.push([entries[i][0],
                                         variable(paramName)]);
    ...
    var _AstToIrVisitor = (function() {
        ...
        _AstToIrVisitor.prototype.visitLiteralMap = function(ast, mode) {
            ...
            for (var i = 0; i < ast.keys.length; i++) {
                parts.push([ast.keys[i],
                            ast.values[i].visit(this, _Mode.Expression)]);
            }
    ...
    function bindRenderText (boundText, compileNode, view) {
        ...
        bind(view, currValExpr, valueField, boundText.value, view.componentContext, [THIS_EXPR.prop('renderer')
                                                                                         .callMethod('setText', [compileNode.renderNode,
                                                                                                                 currValExpr])
            ...
            switch (boundProp.type) {
                case exports.PropertyBindingType.Property:
                    ...
                    updateStmts.push(THIS_EXPR.prop('renderer')
                                         .callMethod('setElementProperty', [renderNode,
                                                                            literal(boundProp.name),
                                                                            renderValue])
                                         .toStmt());
                    break;
                case exports.PropertyBindingType.Attribute:
                    ...
                    updateStmts.push(THIS_EXPR.prop('renderer')
                                         .callMethod('setElementAttribute', [renderNode,
                                                                             literal(boundProp.name),
                                                                             renderValue])
                                         .toStmt());
                    break;
                case exports.PropertyBindingType.Class:
                    updateStmts.push(THIS_EXPR.prop('renderer')
                                         .callMethod('setElementClass', [renderNode,
                                                                         literal(boundProp.name),
                                                                         renderValue])
                                         .toStmt());
                    break;
                case exports.PropertyBindingType.Style:
                    ...
                    updateStmts.push(THIS_EXPR.prop('renderer')
                                         .callMethod('setElementStyle', [renderNode,
                                                                         literal(boundProp.name),
                                                                         renderValue])
                                         .toStmt());
                    break;
                case exports.PropertyBindingType.Animation:
                    ...
                    updateStmts.push(animation.fnVariable.callFn([THIS_EXPR,
                                                                  renderNode,
                                                                  oldRenderVar,
                                                                  newRenderVar])
                                         .toStmt());
                    view.detachMethod.addStmt(animation.fnVariable.callFn([THIS_EXPR,
                                                                           renderNode,
                                                                           oldRenderValue,
                                                                           emptyStateValue])
                                                  .toStmt());
    ...
    function sanitizedValue (boundProp, renderValue) {
        ...
        var args = [importExpr(Identifiers.SecurityContext).prop(enumValue),
                    renderValue];
        ...
        directiveAst.inputs.forEach(function(input) {
            ...
            if (calcChangesMap) {
                ...
                statements.push(DetectChangesVars.changes.key(literal(input.directiveName))
                                    .set(importExpr(Identifiers.SimpleChange).instantiate([fieldExpr,
                                                                                           currValExpr]))
                                    .toStmt());
            }
            if (isOnPushComp) {
    ...
    var CompileEventListener = (function() {
        ...
        CompileEventListener.prototype.listenToRenderer = function() {
            ...
            if (isPresent(this.eventTarget)) {
                listenExpr = ViewProperties.renderer.callMethod('listenGlobal', [literal(this.eventTarget),
                                                                                 literal(this.eventName),
                                                                                 eventListener]);
            }
            else {
                listenExpr = ViewProperties.renderer.callMethod('listen', [this.compileElement.renderNode,
                                                                           literal(this.eventName),
                                                                           eventListener]);
            }
    ...
    var ViewBuilderVisitor = (function() {
        ...
        ViewBuilderVisitor.prototype.visitElement = function(ast, parent) {
            ...
            if (nodeIndex === 0 && this.view.viewType === ViewType.HOST) {
                createRenderNodeExpr = THIS_EXPR.callMethod('selectOrCreateHostElement', [literal(ast.name),
                                                                                          rootSelectorVar,
                                                                                          debugContextExpr]);
            }
            else {
                if (ast.name === NG_CONTAINER_TAG) {
                    createRenderNodeExpr = ViewProperties.renderer.callMethod('createTemplateAnchor', [this._getParentRenderNode(parent),
                                                                                                       debugContextExpr]);
                }
                else {
                    createRenderNodeExpr = ViewProperties.renderer.callMethod('createElement', [this._getParentRenderNode(parent),
                                                                                                literal(ast.name),
                                                                                                debugContextExpr]);
                }
            }
            ...
            if (isPresent(compViewExpr)) {
                ...
                this.view.createMethod.addStmt(compViewExpr
                                                   .callMethod('create', [compileElement.getComponent(),
                                                                          codeGenContentNodes,
                                                                          NULL_EXPR])
                                                   .toStmt());
            }
        ...
        ViewBuilderVisitor.prototype.visitEmbeddedTemplate = function(ast, parent) {
            ...
            var templateVariableBindings = ast.variables.map(function(varAst) {
                return [varAst.value.length > 0 ? varAst.value : IMPLICIT_TEMPLATE_VAR,
                        varAst.name];
            });
            var directives = ast.directives.map(function(directiveAst) { return directiveAst.directive; });
    ...
    function createStaticNodeDebugInfo (node) {
        ...
        if (isPresent(compileElement)) {
            ...
            StringMapWrapper.forEach(compileElement.referenceTokens, function(token, varName) {
                varTokenEntries.push([varName,
                                      isPresent(token) ? createDiTokenExpression(token) : NULL_EXPR]);
            });
        }
    ...
    var LIFECYCLE_INTERFACES = MapWrapper.createFromPairs([
                                                              [LifecycleHooks.OnInit,
                                                               _angular_core.OnInit],
                                                              [LifecycleHooks.OnDestroy,
                                                               _angular_core.OnDestroy],
                                                              [LifecycleHooks.DoCheck,
                                                               _angular_core.DoCheck],
                                                              [LifecycleHooks.OnChanges,
                                                               _angular_core.OnChanges],
                                                              [LifecycleHooks.AfterContentInit,
                                                               _angular_core.AfterContentInit],
                                                              [LifecycleHooks.AfterContentChecked,
                                                               _angular_core.AfterContentChecked],
                                                              [LifecycleHooks.AfterViewInit,
                                                               _angular_core.AfterViewInit],
                                                              [LifecycleHooks.AfterViewChecked,
                                                               _angular_core.AfterViewChecked],
                                                          ]);
        ...
        switch (varNames.length) {
            ...
            case 2:
                return function(d0 /** TODO #9100 */, d1 /** TODO #9100 */) {
                    return _executeFunctionStatements(varNames, [d0,
                                                                 d1], statements, ctx, visitor);
                };
            case 3:
                return function(d0 /** TODO #9100 */, d1 /** TODO #9100 */, d2 /** TODO #9100 */) {
                    return _executeFunctionStatements(varNames, [d0,
                                                                 d1,
                                                                 d2], statements, ctx, visitor);
                };
            case 4:
    ...
    var COMPILER_PROVIDERS =
        ...
        RuntimeCompiler,
        /*@ts2dart_Provider*/
        {provide: _angular_core.ComponentResolver, useExisting: RuntimeCompiler},
