var REFLINKS = {
	"l0": [
		...
		{
			"title":  "HDR Histograms w/o Coordinated Omission (v2.1.9)",
			"anchor": [
				{
	...
	"l1": [
			...
			"anchor": [
				{
					...
					"desc": "One framework - Angular 2"
				},
				{
					"href": "https://angular.io/docs/js/latest/guide/cheatsheet.html",
					"desc": "Angular Cheat Sheet - js"
				},
				{
		...
		{
			"title":  "ng2-nvd3 Charting Library (v1.1.1)",
			"anchor": [
				{
					"href": "https://github.com/krispo/ng2-nvd3",
					"desc": "Angular2 component for nvd3"
				}
			]
		},
		{
